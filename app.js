...
client.on("ready", () => {
  ...
  // randomize game?
  const games = [`Metal Gear Survive 2: Lords of Dust`, 'Metal Gear Rising II: Bladewolves Vengeance', 'Metal Gear Pachinko', 'Metal Gear: Ghost Babel', 'Metal Gear Solid 6: Widow of Cipher', 'Zone of the Enders III: Shadow of Callisto', 'Snatcher 3: Bioroids Divided'];
